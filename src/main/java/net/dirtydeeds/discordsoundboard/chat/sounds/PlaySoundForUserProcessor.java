...
public class PlaySoundForUserProcessor extends
  ...
  protected void handleEvent(MessageReceivedEvent event, String message) {
    ...
    if (!bot.isAllowedToPlaySound(user)) {
      ...
      JDALogger.getLog("Sound").info(String.format("%s tried to play sound file but is not allowed.",
                             user));
      ...
      JDALogger.getLog("Sound").info(String.format("%s is playing sound file \"%s\" for user %s.",
