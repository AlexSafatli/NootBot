...
public class Periodic {
  ...
  public static final int EVERY_TWELVE_HOURS = 12 * EVERY_HOUR;
  public static final int EVERY_DAY = 24 * EVERY_HOUR;
  public static final int EVERY_TWO_DAYS = 2 * EVERY_DAY;
  public static final int EVERY_WEEK = 7 * EVERY_DAY;
