...
public class StatusProcessor extends SingleArgumentChatCommandProcessor {
	...
	protected void handleEvent(MessageReceivedEvent event, String message) {
		...
		if (user.getUsername().equalsIgnoreCase(bot.getOwner())) pm(event, "This user is the **bot's owner**.");
	}

	@Override
	public String getCommandHelpString() {
		return "`" + getPrefix() + " [username]` - PMs you what this bot knows about you (or someone else if given)";
	}
